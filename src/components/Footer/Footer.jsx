      ...
      <div className="container">
        <div className={styles.grid}>
          <div className={styles.brandCol}>
            ...
            <p className={styles.tagline}>
              Empowering businesses with innovative IT solutions and digital transformation
          ...
          <div className={styles.linkCol}>
            ...
            <ul className={styles.contactList}>
              <li>
                ...
                <a href="mailto:info@bluenova.com">info@bluenova.com</a>
              </li>
              <li>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            &copy; {currentYear} BlueNova IT Services. All rights reserved.
          </p>
          <div className={styles.legal}>
            {FOOTER_LINKS.legal.map((link) => (
              <Link key={link.path} to={link.path} className={styles.legalLink}>
                {link.label}
              </Link>
            ))}
          </div>
